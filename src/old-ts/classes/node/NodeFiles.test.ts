...
describe( 'NodeFiles', () => {
    ...
    test( 'NodeFiles.pathRelative()', () => {
        ...
        const testSets: [ string, string ][] = [
            [
                '/Users/maddi/— Local Files/Coding - Local/utility-js/package.json',
                'package.json',
            ],
            [
                '/Users/maddi/— Local Files/Coding - Local/utility-js/.scripts/',
                '.scripts',
            ],
            [
                '/Users/maddi/— Local Files/Coding - Local/utility-js/',
                '.',
            ],
        ];
    ...
    test( 'NodeFiles.pathResolve()', () => {
        ...
        const testSets: [ string[], string ][] = [
            ...
            [
                [ '.scripts', 'package.ts' ],
                '/Users/maddi/— Local Files/Coding - Local/utility-js/.scripts/package.ts'
            ],
            [
                [ '.scripts', 'classes/' ],
                '/Users/maddi/— Local Files/Coding - Local/utility-js/.scripts/classes'
            ],
        ];
