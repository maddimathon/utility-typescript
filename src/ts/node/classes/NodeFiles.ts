...
export class NodeFiles {
     ...
     * @category Args
     */
    public readonly args: NodeFiles.Args;
    ...
    public constructor (
        ...
        this.args = mergeArgs( this.ARGS_DEFAULT as NodeFiles.Args, args, true );
    ...
    public copyFile(
        ...
        args = mergeArgs( this.args.copyFile, args, false );
    ...
    public readDir(
        ...
        args = mergeArgs( this.args.readDir, args, false );
    ...
    public write(
        ...
        args = mergeArgs( this.args.write, args, false );
