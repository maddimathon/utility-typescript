 ...
 */
export type ToEntry<
    O extends {} = { [ key: number | string | symbol ]: any; }
> = { readonly [ K in keyof Required<O> ]: [ K, O[ K ] ] }[ keyof O ];
 ...
 * @expand
 */
export type ToEntryReadonly<
    O extends {} = { [ key: number | string | symbol ]: any; }
> = { readonly [ K in keyof Required<O> ]: readonly [ K, O[ K ] ] }[ keyof O ];
 ...
 * @expand
 */
export type ToEntriesArrayReadonly<
    O extends {} = { [ key: number | string | symbol ]: any; }
> = readonly { readonly [ K in keyof Required<O> ]: readonly [ K, O[ K ] ] }[ keyof O ][];
...
export type FromEntries<
    T_Entries extends ToEntriesArray | ToEntriesArrayReadonly
> = MergeObjectsUnion<FromEntries.Internal<FromEntries.TuplifyUnion<T_Entries[ number ]>>>;
...
export namespace FromEntries {
     ...
     * @expand
     */
    export type Internal<T_Entries extends [ ...any[] ]> = {
    ...
    export type TuplifyUnion<
        T,
        L = UnionToIntersection<T extends any ? () => T : never> extends () => ( infer R ) ? R : never,
