...
export type RecursiveRequired<T> = {
    [ K in keyof T ]-?:
    Required<T>[ K ] extends number | null | string | undefined | AnyClass | Function | Date
    ? Required<T>[ K ]
 ...
 */
export type RequiredPartially<
    T_Object,
    T_RequiredKeys extends keyof T_Object = never,
> =
    Required<Pick<T_Object, T_RequiredKeys>>
    & Omit<T_Object, T_RequiredKeys>;
 ...
 * @param T_RequiredKeys  Keys that cannot be undefined. Default `never`.
 */
export type RecursiveRequiredPartially<
    T_Object,
    T_RequiredKeys extends keyof T_Object = never,
> =
    RecursiveRequired<Pick<T_Object, T_RequiredKeys>>
    & Omit<T_Object, T_RequiredKeys>;