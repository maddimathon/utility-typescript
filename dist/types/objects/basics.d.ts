...
export type RecursivePartial<T extends Record<number | string, any>> = {
    [K in keyof T]?: T[K] extends (infer I)[] ? RecursivePartial_Inner<I>[] : RecursivePartial_Inner<T[K]>;
};
/**
 ...
 * @expand
 */
export type RequirePartial<T, RequiredKeys extends keyof T = never> = RecursiveRequired<Pick<T, RequiredKeys>> & Omit<T, RequiredKeys>;
export {};
